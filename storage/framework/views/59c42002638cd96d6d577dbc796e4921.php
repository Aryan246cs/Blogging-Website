...
<body class="bg-gray-100 text-gray-800 min-h-screen font-sans">
        ...
        <div class="border-2 border-black p-6 m-4 bg-white rounded-lg shadow">
            ...
            <table class="w-full text-left border border-gray-300 mb-4">
                <tr class="bg-gray-200">
                    ...
                    <td class="p-2"><?php echo e(auth()->user()->name); ?></td>
                </tr>
                <tr>
                    <th class="p-2 bg-gray-200">Email</th>
                    <td class="p-2"><?php echo e(auth()->user()->email); ?></td>
                </tr>
                <tr>
                    <th class="p-2 bg-gray-200">Gender</th>
                    <td class="p-2"><?php echo e(auth()->user()->gender); ?></td>
                </tr>
                <tr>
                    <th class="p-2 bg-gray-200">Date of Birth</th>
                    <td class="p-2"><?php echo e(auth()->user()->dob); ?></td>
                </tr>
                <tr>
                    <th class="p-2 bg-gray-200">State</th>
                    <td class="p-2"><?php echo e(auth()->user()->state); ?></td>
                </tr>
                <tr>
                    <th class="p-2 bg-gray-200">District</th>
                    <td class="p-2"><?php echo e(auth()->user()->district); ?></td>
                </tr>
            </table>

            <div class="mb-6">
                <a href="<?php echo e(route('dashboard.edit')); ?>"
                    class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mr-2">Edit Profile</a>

                <form action="<?php echo e(route('dashboard.delete')); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
            ...
            <form action="/register" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <select id="state" name="state" class="border px-3 py-2 rounded w-full">
                        ...
                        <?php $__currentLoopData = json_decode(file_get_contents(public_path('states_districts.json')), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state => $districts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(url('/explore-posts')); ?>"
                class="inline-block bg-indigo-500 hover:bg-indigo-600 text-white px-5 py-2 rounded">View Public Posts</a>
        </div>
    <?php endif; ?>
</body>

</html><?php /**PATH C:\Users\user\Desktop\laravel projects\crud_app\resources\views/home.blade.php ENDPATH**/ ?>